...
//      is_done column is using the integer datatype because SQLite doesn't have a separate boolean
//          datatype/storage class. Boolean values are stored as integers.
    }
}
